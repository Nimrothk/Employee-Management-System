...
<body>
	...
	<div class="col-9">
		<a href="Option.jsp">Home</a> <a href="Add_Employee.jsp">Add
			Employee</a> <a class="active" href="List_Employees.jsp">View
	...
	<%
		...
		if (request.getParameter("search") == null) {
			...
			resultset = statement.executeQuery("select * from user WHERE name LIKE '%" + s
		...
		<table class="table">
			...
			<form action="" method="post">
				<input type="text" name="search"
					placeholder="Search...    Id / Name / User Name">
			</form>
 ...
 %>
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="Delete_user?id=<%out.print(id);%>">
							<button class="btn btn-primary btn-sm">Delete</button>
					</a></td>

					<td><a href="View_user?id=<%out.print(id);%>">
							<a class="btn btn-primary btn-sm" href="Leave_calculate.jsp">View</a>
					</a></td>
