...
<body>
 ...
 %>
				...
				</span> <span class="login100-form-title p-b-37">Change Password</span>

				<div class="wrap-input100 validate-input m-b-20"
					data-validate="Enter Current Password">
					<input class="input100" type="password" name="currentpass"
