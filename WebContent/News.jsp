...
<body>
	...
	<div class="col-9">
		<a href="Option.jsp">Home</a> <a href="Add_Employee.jsp">Add
			...
			Admin</a> <a class="active" href="News.jsp">Post News</a> <a
	...
	<div class="container-login100"
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" method="post" action="News">
 ...
 %>
				...
				</span> <span class="login100-form-title p-b-37"> Add Message </span>
				...
				<div class="wrap-input100 validate-input m-b-25"
					data-validate="Enter subtitle">
					<input class="input100" type="text" name="subtitle"
						placeholder="Sub title"> <span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25"
					data-validate="Enter message">
					<input class="input100" type="text" name="message"
						placeholder="Enter message here"> <span
				...
				<div class="text-center">
					<a href="List_News.jsp" class="txt2 hov1"> List All News </a>
				</div>
