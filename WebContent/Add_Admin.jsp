...
<body>
	...
	<div class="col-9">
		<a href="Option.jsp">Home</a> <a href="Add_Employee.jsp">Add
			...
			class="active" href="Add_Admin.jsp">Add Admin</a> <a
 ...
 %>
				...
				</span> <span class="login100-form-title p-b-37"> Add Admin </span>

				<div class="wrap-input100 validate-input m-b-20"
					data-validate="Enter admin name">
					<input class="input100" type="text" name="Name"
						placeholder="Admin Name"> <span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input m-b-25"
					data-validate="Enter Position">
					<input class="input100" type="text" name="Position"
						placeholder="Position"> <span class="focus-input100"></span>
				</div>
				...
				<div class="text-center">
					<a href="List_Admin.jsp" class="txt2 hov1"> List All Admins </a>
				</div>
			</form>
